      ...
      <Grid item xs={12} sm={6}>
        <Card>
          <CardContent>
            ...
            <Button onClick={() => navigate("/barber/dashboard/haircuts/templates")} sx={{ mt: 2 }} variant="contained">
              Go to Templates
            </Button>
          </CardContent>
        </Card>
      ...
      <Grid item xs={12} sm={6}>
        <Card>
          <CardContent>
            ...
            <Button onClick={() => navigate("/barber/dashboard/haircuts/custom")} sx={{ mt: 2 }} variant="contained">
              Manage Cuts
            </Button>
          </CardContent>
        </Card>
