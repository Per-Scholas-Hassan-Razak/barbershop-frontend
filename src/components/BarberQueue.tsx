...
import type { BarberQueueResponse } from "../types";
      ...
      <Card>
        <CardContent>
          ...
          <FormControl fullWidth sx={{ mt: 2 }}>
            ...
            >
              {/* Demo — replace with actual haircuts from barber’s offerings */}
              <MenuItem value="cut1">Basic Fade</MenuItem>
              <MenuItem value="cut2">Buzz Cut</MenuItem>
              <MenuItem value="cut3">Line-Up + Beard</MenuItem>
            </Select>
          </FormControl>
{/* 
          <Button
