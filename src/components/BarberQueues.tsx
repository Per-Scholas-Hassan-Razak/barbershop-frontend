...
const DEFAULT_BARBER_IMG = "https://www.goodfreephotos.com/people/barber-giving-a-haircut.jpg";
...
{queues.map((q) => (
  <Grid item xs={12} sm={6} md={4} key={q._id}>
    <Card>
      <CardContent>
        <Typography variant="h6">{(q.barber.username).toUpperCase()}</Typography>
          <img
